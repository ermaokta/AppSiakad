...
public class IfrProdi extends javax.swing.JInternalFrame {
    ...
    private void setTabelProdi(){
        ...
        tbDataProdi.getColumnModel().getColumn(2).setPreferredWidth(252);
    }
    ...
    private void listJurusan(){
        try{
            ...
            System.out.println("Error method listJurusa() : " +ex);
        }
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cmbJurusan, javax.swing.GroupLayout.PREFERRED_SIZE, 385, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        if(cmbJurusan.getSelectedIndex()<=0){
            JOptionPane.showMessageDialog(this, "Jurusan harus diilih", "Informasi",
    ...
    private void tbDataProdiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDataProdiMouseClicked
        if(evt.getClickCount()==2){
            ...
            vprodi = tbDataProdi.getValueAt(brs, 1).toString();
